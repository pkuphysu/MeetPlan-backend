...
from django.contrib.auth.forms import UserCreationForm as BaseUserCreationForm, \
    UsernameField, UserChangeForm as BaseUserChangeForm
...
class UserAdmin(GuardedModelAdminMixin, BaseUserAdmin):
    fieldsets = (
        ...
        (_('Personal info'), {
            'fields': ('name', 'email', 'website', 'phone_number', 'address', 'introduce')
        }),
        (_('Permissions'), {
            'fields': ('is_active', 'is_teacher', 'is_admin', 'is_staff', 'is_superuser',
                       'department', 'groups', 'user_permissions'),
        }),
